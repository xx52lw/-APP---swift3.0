...
// =================================================================================================================================
// MARK: - 选择性别视图代理
protocol LWSelectSexViewDelegate : NSObjectProtocol {
    func selectSexView(view : LWSelectSexView,sexBtn : UIButton)
}
// MARK: - 选择性别视图
class LWSelectSexView : UIView {
    
    weak var  deleagte : LWSelectSexViewDelegate?
    ...
    func btnClick(btn : UIButton){
        deleagte?.selectSexView(view: self, sexBtn: btn)
        print("tag = \(btn.tag)")
    }
