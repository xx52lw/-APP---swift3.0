//
//  LWHomeDrawModel.swift
//  dangtangDemo
//
//  Created by liwei on 16/12/15.
//  Copyright © 2016年 张星星. All rights reserved.
//

import UIKit

class LWHomeDrawModel: NSObject {
    /// 绘制简介cell
    class func drawHomeCell(tableView: UITableView, cell: LWHomeTableViewCell, info: LWHomeRequestDataInfo) {
